...
local function set_repl_winbar()
	if vim.bo.filetype == "clojure" then
		vim.opt_local.winbar = (
			...
			.. "%="
			.. "%#user.repl.winbar# "
			.. "%{%v:lua.require'rajnvim.tools.nrepl'.get_repl_status('no REPL')%}"
			.. "%#winbarseparator#"
		)
	end
end
...
M.config = function()
	...
	local mappings = require("rajnvim.tools.portal-mappings")
	local wk = require("which-key")
	local repl = require("rajnvim.tools.nrepl")
	local u = require("rajnvim.tools.conjure-util")
